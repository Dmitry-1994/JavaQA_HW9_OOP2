...
public class RadioTest {
    ...
    public void shouldNextStation(int countRadiostation, int curentRadiostation, int expected) {
    ...
    public void shouldPrevtStation(int countRadiostation, int curentRadiostation, int expected) {
        Radio radio = new Radio(countRadiostation);
        radio.setNumderCurentRadiostation(curentRadiostation);
        radio.prev();
        int actual = radio.getNumderCurentRadiostation();
